...
ORCHESTRATOR_TOOLS = [
    ...
    _t("build_agent", "Create a new autonomous agent",
       {"name": {"type": "string", "description": "Agent name"},
        ...
        "icon": {"type": "string", "description": "Emoji icon"}}, ["name", "goal"]),
    ...
    _t("present_options", "Show user a choice",
       {"question": {"type": "string"}, "options": {"type": "array", "items": {"type": "string"}}}, ["question", "options"]),
    ...
    _t("check_integrations", "Check which OAuth integrations are connected and which are missing",
       {"tools": {"type": "array", "items": {"type": "string"}, "description": "Tool names that need integrations"}}, ["tools"]),
