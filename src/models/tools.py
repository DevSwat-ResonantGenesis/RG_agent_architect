...
ORCHESTRATOR_TOOLS = [
    ...
    _t("present_options", "Show user a choice between 2-6 options, rendered inline in chat as clickable controls",
       {"question": {"type": "string"},
        "options": {"type": "string", "description": "Comma-separated list of options"},
        "kind": {"type": "string", "description": "How to render the choice: 'buttons' (default, single pick, sends immediately), 'tabs' (single pick, user can switch before confirming), 'checkbox' (multi-select, user confirms with Continue)"}},
       ["question", "options"]),
